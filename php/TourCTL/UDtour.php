...
<head>
    ...
    <title>Cập nhật Tour - Admin</title>
    ...
    <div class="main">
        ...
        <section class="content">
            ...
            <div class="content-header">
                <h2><i class="bi bi-pencil-square"></i> Cập nhật thông tin Tour</h2>
                <button onclick="window.location.href='../../html/Admin/TourController.php'" class="btn btn-secondary">
                ...
                <form action="UDController.php?id=<?php echo $tour['id']; ?>" method="POST" enctype="multipart/form-data">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" value="<?php echo $tour['ma_tour']; ?>" class="form-control" id="maTour" name="maTour" placeholder="VD: VN001" required>
                        </div>

                        <div class="col-md-6">
                            <label for="tenTour" class="form-label">Tên Tour</label>
                            <input type="text" value="<?php echo $tour['ten_tour']; ?>" class="form-control" id="tenTour" name="tenTour" placeholder="VD: Hành trình miền Trung" required>
                        </div>

                        <div class="col-md-6">
                            <label for="loaiTour" class="form-label">Loại Tour</label>
                            <select id="loaiTour" name="loaiTour" class="form-select" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" value="<?php echo $tour['ngay_khoi_hanh']; ?>" class="form-control" id="ngayKhoiHanh" name="ngayKhoiHanh" required>
                        </div>

                        <div class="col-md-6">
                            <label for="diemKhoiHanh" class="form-label">Điểm khởi hành</label>
                            <input type="text" value="<?php echo $tour['diem_khoi_hanh']; ?>" class="form-control" id="diemKhoiHanh" name="diemKhoiHanh" placeholder="VD: Hà Nội, TP. Hồ Chí Minh..." required>
                        </div>

                        <div class="col-md-6">
                            <label for="soNgay" class="form-label">Số ngày</label>
                            <input type="number" value="<?php echo $tour['so_ngay']; ?>" class="form-control" id="soNgay" name="soNgay" placeholder="VD: 5" min="1" required>
                        </div>

                        <div class="col-md-4">
                            <label for="giaNguoiLon" class="form-label">Giá người lớn (VNĐ)</label>
                            <input type="number" value="<?php echo $tour['gia_nguoi_lon']; ?>" class="form-control" id="giaNguoiLon" name="giaNguoiLon" placeholder="VD: 4500000" min="0" required>
                        </div>

                        <div class="col-md-4">
                            <label for="giaTreEm" class="form-label">Giá trẻ em (2 - 9 tuổi)</label>
                            <input type="number" value="<?php echo $tour['gia_tre_em']; ?>" class="form-control" id="giaTreEm" name="giaTreEm" placeholder="VD: 3000000" min="0" required>
                        </div>

                        <div class="col-md-4">
                            <label for="giaTreNho" class="form-label">Giá trẻ nhỏ (&lt; 2 tuổi)</label>
                            <input type="number" value="<?php echo $tour['gia_tre_nho']; ?>" class="form-control" id="giaTreNho" name="giaTreNho" placeholder="VD: 1000000" min="0" required>
                        </div>

                        <div class="col-md-12">
                            <label for="vitri" class="form-label">Vị trí trực thuộc</label>
                            <input type="text" name="vitri" id="vitri" class="form-control" value="<?php echo $tour['vi_tri']; ?>" placeholder="VD: Miền Trung" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-text">
                                <i class="bi bi-image"></i> Ảnh hiện tại: <strong><?php echo $tour['hinh_anh']; ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-text">
                                <i class="bi bi-info-circle"></i> Giữ Ctrl (hoặc Cmd) để chọn nhiều ảnh. Bỏ trống nếu không muốn thay đổi.
                            </div>
                        </div>

                        <div class="col-12">
                            <label for="dichVu" class="form-label">
                                <i class="bi bi-grid-3x3-gap"></i> Dịch vụ
                            </label>
                        ...
                        <div class="col-12">
                            <label for="loTrinh" class="form-label">
                                <i class="bi bi-map"></i> Lộ trình chi tiết
                            </label>
                        ...
                        <div class="col-12">
                            <label for="traiNghiem" class="form-label">
                                <i class="bi bi-star"></i> Trải nghiệm nổi bật
                            </label>
                        ...
                        <div class="col-12 text-end mt-4">
                            <button type="button" onclick="window.location.href='../../html/Admin/TourController.php'" class="btn btn-secondary me-2">
        ...
        document.getElementById('anhDaiDien').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    // Có thể thêm preview ảnh nếu muốn
