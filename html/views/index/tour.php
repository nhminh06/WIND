...
// Lọc theo đánh giá (nếu có cột rating trong database)
// if ($rating > 0) {
//     $sql_count .= " AND rating >= $rating";
//     $sql_httour .= " AND rating >= $rating";
// }
    ...
    <div class="tour_container2">
        ...
        <?php if (!empty($_key) || !empty($tour_type) || !empty($locations) || $min_price > 0 || $max_price < 10000000 || !empty($duration) || $rating > 0): ?>
            <div class="filter-info">
                ...
                <?php if (!empty($_key)): ?>
                    <span class="filter-badge keyword">
                        <i class="bi bi-search"></i> Từ khóa: <?php echo htmlspecialchars($_key); ?>
                    </span>
                <?php endif; ?>
                
                <?php if (!empty($tour_type)): ?>
                    <span class="filter-badge tour-type">
                        <?php echo $tour_type == 'trong_ngay' ? '<i class="bi bi-alarm"></i> Trong ngày' : '<i class="bi bi-calendar"></i> Dài ngày'; ?>
                    </span>
                <?php endif; ?>
                
                <?php if (!empty($locations)): ?>
                    <?php foreach ($locations as $loc): ?>
                        <span class="filter-badge location">
                            <i class="bi bi-geo-alt"></i> <?php echo htmlspecialchars($loc); ?>
                        </span>
                    <?php endforeach; ?>
                <?php endif; ?>
                
                <?php if ($min_price > 0 || $max_price < 10000000): ?>
                    <span class="filter-badge price">
                        <i class="bi bi-cash-coin"></i> <?php echo number_format($min_price, 0, ',', '.'); ?> - <?php echo number_format($max_price, 0, ',', '.'); ?> VNĐ
                    </span>
                <?php endif; ?>
                
                <?php if (!empty($duration)): ?>
                    <span class="filter-badge duration">
                ...
                <?php if ($rating > 0): ?>
                    <span class="filter-badge rating">
                        <i class="bi bi-star-fill"></i> <?php echo $rating; ?> sao trở lên
                    </span>
                <?php endif; ?>
                
                <span class="filter-count">
                    <?php echo $total_tours; ?> tour
                </span>
            </div>
        <?php endif; ?>
...
// Hàm set thời gian (toggle on/off)
...
// Auto-submit form khi thay đổi checkbox địa điểm
...
// Auto-submit form khi thay đổi rating
