...
if (isset($_GET['id'])) {
    ...
    $sql_get = "SELECT trang_thai FROM khampha WHERE khampha_id  = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        // Cập nhật trạng thái
        $sql_update = "UPDATE khampha SET trang_thai = ? WHERE khampha_id = ?";
...
$conn->close();
header("Location: ../../html/Admin/ExploreController.php");
exit();
?>
